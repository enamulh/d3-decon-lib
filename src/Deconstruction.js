...
var Deconstruction = function(labels, svg, groups, unbound, axes, mappingSets) {
    var groupData = [];
...
Deconstruction.fromJSON = function(json) {
    return new Deconstruction(json.labels, json.svg, json.groups, json.unbound, json.axes, json.mappingSets);
};
